...
import { Search, Bell, User as UserIcon, LogOut, ChevronDown, Building, FileText as FileTextIcon } from 'lucide-react';
  ...
  return (
    <header className="h-16 bg-surface border-b border-border flex items-center justify-between px-4 sm:px-6 lg:px-8 flex-shrink-0">
      <div className="relative flex-1 max-w-xl">
        ...
        <input
          type="text"
          placeholder="Pesquisar clientes, contratos..."
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          ...
          >
            ...
            <ChevronDown className="w-4 h-4 text-subtle hidden sm:block" />
          </button>
          {dropdownOpen && (
